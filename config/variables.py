...
variables.append(Variable("dimuon_mass", r"$m_{\mu\mu}$ [GeV]", 70, 100, 150))
variables.append(Variable("wgt_zpt_wgt_nominal", "wgt_zpt_wgt_nominal", 70, 0.5, 1.8))
variables.append(Variable("zpt_weight", "zpt_weight", 70, 0.5, 1.8))
...
variables.append(Variable("dimuon_pt", r"$p_{T}(\mu\mu)$ [GeV]", 70, 0, 200))
#variables.append(Variable("dimuon_pt_zpt_wgt_off", r"$p_{T}(\mu\mu)$ [GeV]", 30, 0, 300))
variables.append(Variable("dimuon_pt_log", r"$log(p_{T}(\mu\mu))$", 70, 0, 200))
variables.append(Variable("dimuon_eta", r"$\eta (\mu\mu)$", 70, -5, 5))
variables.append(Variable("dimuon_phi", r"$\phi (\mu\mu)$", 70, -3.2, 3.2))
variables.append(Variable("dimuon_dEta", r"$\Delta\eta (\mu\mu)$", 70, 0, 10))
variables.append(Variable("dimuon_dPhi", r"$\Delta\phi (\mu\mu)$", 70, 0, 4))
variables.append(Variable("dimuon_dR", r"$\Delta R (\mu\mu)$", 70, 0, 4))
variables.append(Variable("dimuon_cos_theta_cs", r"$\cos\theta_{CS}$", 70, -1, 1))
...
variables.append(Variable("mu1_pt", r"$p_{T}(\mu_{1})$ [GeV]", 70, 20, 200))
variables.append(Variable("mu1_pt_raw", r"$p_{T}(\mu_{1})$ [GeV]", 70, 20, 200))
variables.append(Variable("mu1_bsConstrainedPt", r"$p_{T}(\mu_{1})$ [GeV]", 70, 20, 200))
variables.append(Variable("mu1_bsConstrainedChi2", r"$\chi^{2}(\mu_{1}))$", 70, 20, 200))
variables.append(
    Variable("mu1_pt_over_mass", r"$p_{T}(\mu_{1})/M_{\mu\mu}$ [GeV]", 50, 0, 2)
)
variables.append(Variable("mu1_eta", r"$\eta (\mu_{1})$", 70, -2.5, 2.5))
variables.append(Variable("mu1_phi", r"$\phi (\mu_{1})$", 70, -3.2, 3.2))
variables.append(Variable("mu1_iso", r"iso$(\mu1)$", 30, 0, 0.3))
variables.append(Variable("mu2_pt", r"$p_{T}(\mu_{2})$ [GeV]", 70, 0, 300))
variables.append(Variable("mu2_pt_raw", r"$p_{T}(\mu_{12})$ [GeV]", 70, 20, 120))
variables.append(Variable("mu2_bsConstrainedPt", r"$p_{T}(\mu_{2})$ [GeV]", 70, 20, 120))
variables.append(Variable("mu2_bsConstrainedChi2", r"$\chi^{2}(\mu_{2}))$", 70, 20, 120))
variables.append(
    Variable("mu2_pt_over_mass", r"$p_{T}(\mu_{2})/M_{\mu\mu}$ [GeV]", 50, 0, 2)
)
variables.append(Variable("mu2_eta", r"$\eta (\mu_{2})$", 70, -2.5, 2.5))
variables.append(Variable("mu2_phi", r"$\phi (\mu_{2})$", 70, -3.2, 3.2))
variables.append(Variable("mu2_iso", r"iso$(\mu2)$", 70, 0, 0.3))
variables.append(Variable("jet1_pt", r"$p_{T}(jet1)$ [GeV]", 70, 25, 250))
variables.append(Variable("jet1_eta", r"$\eta (jet1)$", 70, -4.7, 4.7))
variables.append(Variable("jet1_phi", r"$\phi (jet1)$", 70, -3.2, 3.2))
variables.append(Variable("jet1_qgl", r"$QGL (jet1)$", 70, 0, 1))
variables.append(Variable("jet1_id", "jet1 ID", 9, 0, 8))
variables.append(Variable("jet1_puid", "jet1 PUID", 9, 0, 8))
variables.append(Variable("mmj1_dEta", r"$\Delta\eta (\mu\mu, jet1)$", 70, 0, 10))
variables.append(Variable("mmj1_dPhi", r"$\Delta\phi (\mu\mu, jet1)$", 70, 0, 4))
variables.append(Variable("jet2_pt", r"$p_{T}(jet2)$ [GeV]", 70, 25, 250))
variables.append(Variable("jet2_eta", r"$\eta (jet2)$", 70, -4.7, 4.7))
variables.append(Variable("jet2_phi", r"$\phi (jet2)$", 70, -3.2, 3.2))
variables.append(Variable("jet2_qgl", r"$QGL (jet2)$", 70, 0, 1))
...
variables.append(Variable("jj_mass", r"$M(jj)$ [GeV]", 50, 0, 2500))
