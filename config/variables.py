...
variables.append(Variable("mu1_pt", r"$p_{T}(\mu_{1})$ [GeV]", 50, 20, 200))
variables.append(Variable("mu1_pt_raw", r"$p_{T}(\mu_{1})$ [GeV]", 50, 20, 200))
variables.append(Variable("mu1_bsConstrainedPt", r"$p_{T}(\mu_{1})$ [GeV]", 50, 20, 200))
variables.append(Variable("mu1_bsConstrainedChi2", r"$\chi^{2}(\mu_{1}))$", 50, 20, 200))
variables.append(
...
variables.append(Variable("mu2_pt_raw", r"$p_{T}(\mu_{12})$ [GeV]", 50, 20, 120))
variables.append(Variable("mu2_bsConstrainedPt", r"$p_{T}(\mu_{2})$ [GeV]", 50, 20, 120))
variables.append(Variable("mu2_bsConstrainedChi2", r"$\chi^{2}(\mu_{2}))$", 50, 20, 120))
variables.append(
