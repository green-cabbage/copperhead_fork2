...
parameters = {
    ...
    #
    # < plotting settings >
    "plot_vars": ["jj_dEta","jj_mass","jj_dPhi","jj_eta","jj_pt","njets","jet1_pt","njets","jet1_eta","jet2_eta","jet2_pt"],
    #["dimuon_mass","dimuon_pt","dimuon_ebe_mass_res","dimuon_pisa_mass_res","dimuon_cos_theta_cs","zeppenfeld","jj_dEta","dimuon_phi_cs","jj_mass","dimuon_dR","njets","mu1_pt","mu1_eta","jet1_pt","njets","mmj_min_dEta","mmj2_dPhi","jet1_eta", "jet1_phi",],
    #"plot_vars": ["njets"],
